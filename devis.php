    ...
    <header class="page-header">
       ...
       <?php include './Includes/menu.php'; ?>
		...
		<div class="container">
			<div class="grid_12">
									<div class="imageillu">
						<img src="./uploads/2015/03/devis2.png">					</div>
					<h1><span>Devis</span> en ligne</h1>
													<div class="page-path">
						<div id="crumbs" xmlns:v="http://rdf.data-vocabulary.org/#"><span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" href="/web/20150628025921/http://www.unitedtelecom.fr/">Accueil</a></span> <span class="delimiter">|</span> <span class="current"><span>Devis</span> en ligne</span></div>					</div>
							</div>
		</div>
	</div>
	</div>
...
<form name="" action="/web/20150628025921/http://www.unitedtelecom.fr/devis-en-ligne/#wpcf7-f276-p131-o1" method="post" class="wpcf7-form cf7-style twenty-fifteen-pattern" novalidate="novalidate">
<div style="display: none;">
<input type="hidden" name="_wpcf7" value="276">
<input type="hidden" name="_wpcf7_version" value="4.1.2">
<input type="hidden" name="_wpcf7_locale" value="fr_FR">
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f276-p131-o1">
<input type="hidden" name="_wpnonce" value="03ae8ac8df">
</div>
<h4><span style="color: #b4b4b4;">Vos</span> besoins</h4>
<div class="presta">
<p><img src="./uploads/2015/01/telephone.png"><br>
<span class="wpcf7-form-control-wrap presta1"><span class="wpcf7-form-control wpcf7-checkbox"><span class="wpcf7-list-item first last"><input type="checkbox" name="presta1[]" value="Téléphonie">&nbsp;<span class="wpcf7-list-item-label">Téléphonie</span></span></span></span></p>
<p><img src="./uploads/2014/03/operateur.png"><br>
<span class="wpcf7-form-control-wrap presta2"><span class="wpcf7-form-control wpcf7-checkbox"><span class="wpcf7-list-item first last"><input type="checkbox" name="presta2[]" value="Opérateur">&nbsp;<span class="wpcf7-list-item-label">Opérateur</span></span></span></span></p>
<p><img src="./uploads/2014/03/reseau.png"><br>
<span class="wpcf7-form-control-wrap presta3"><span class="wpcf7-form-control wpcf7-checkbox"><span class="wpcf7-list-item first last"><input type="checkbox" name="presta3[]" value="Câblage &amp; réseau">&nbsp;<span class="wpcf7-list-item-label">Câblage &amp; réseau</span></span></span></span></p>
<p><img src="./uploads/2014/03/video.png"><br>
<span class="wpcf7-form-control-wrap presta4"><span class="wpcf7-form-control wpcf7-checkbox"><span class="wpcf7-list-item first last"><input type="checkbox" name="presta4[]" value="Vidéosurveillance">&nbsp;<span class="wpcf7-list-item-label">Vidéosurveillance</span></span></span></span></p>
<p><img src="./uploads/2014/03/alarme.png"><br>
<span class="wpcf7-form-control-wrap presta5"><span class="wpcf7-form-control wpcf7-checkbox"><span class="wpcf7-list-item first last"><input type="checkbox" name="presta5[]" value="Alarme &amp; sécurité">&nbsp;<span class="wpcf7-list-item-label">Alarme &amp; sécurité</span></span></span></span></p>
</div>
...
<h4>Vos <span style="color: #b4b4b4;">coordonnées</span></h4>
<div class="une-ligne">
...
<div class="wpcf7-response-output wpcf7-display-none"></div></form></div>
				...
				<?php include './Includes/aside.php'; ?>	</div>
</div>
